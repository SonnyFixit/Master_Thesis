...
def train_lstm_on_bigdata(data_file, classification_file, segment_info_file, log_file_path):
    ...
    for train_segments, train_labels, val_segments, val_labels in fold_sets:
        ...
        train_loader = DataLoader(train_dataset, batch_size=128, shuffle=True, num_workers=12, persistent_workers=True)
        val_loader = DataLoader(val_dataset, batch_size=256, shuffle=False, num_workers=12, persistent_workers=True)
