...
# Zmodyfikowana funkcja treningowa z podsumowaniem
def train_lstm_on_bigdata(data_file, classification_file, segment_info_file, log_file_path):
    ...
    # Listy do podsumowania wyników wszystkich foldów
    overall_accuracies = []
    overall_precisions = []
    overall_recalls = []
    overall_f1_scores = []
    ...
    for train_segments, train_labels, val_segments, val_labels in fold_sets:
        ...
        # Zapisanie wyników dla folda do listy
    ...
    # Logowanie podsumowania wyników po cross-validation
    log_message("\n" + "=" * 50, log_file_path)
