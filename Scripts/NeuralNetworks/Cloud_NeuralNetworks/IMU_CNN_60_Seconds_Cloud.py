...
class IMUCNN(nn.Module):
    def __init__(self, input_size=24, num_classes=2):
        ...
        self.conv5 = nn.Conv1d(512, 1024, kernel_size=3, padding=1)  # Additional convolutional layer
        self.conv6 = nn.Conv1d(1024, 2048, kernel_size=3, padding=1) # Another additional convolutional layer
        ...
        self.fc2 = nn.Linear(512, 256)  # Dodatkowa warstwa w pełni połączona
        self.fc3 = nn.Linear(256, num_classes)

    def calculate_flatten_size(self):
        # Symulacja przejścia przez warstwy, aby obliczyć rozmiar wyjściowy
        sample_input = torch.zeros(1, 24, 6000)  # Próbka danych z tym samym wymiarem co dane wejściowe
...
def train_cnn_on_bigdata(data_file, classification_file, segment_info_file, log_file_path):
    ...
    for train_segments, train_labels, val_segments, val_labels in fold_sets:
        ...
        weight_for_class_0 = max(class_counts) / class_counts[0] * 7.0  # Zwiększona waga dla negatywnej klasy
        ...
        with torch.no_grad():
            for idx, (inputs, labels) in enumerate(val_loader):
                ...
                predicted = (probabilities[:, 1] > 0.1).long()  # Obniżenie progu, aby zwiększyć czułość
...
if __name__ == "__main__":
    ...
    data_file = "/content/drive/My Drive/IMU_Segmented_60s_BigDataset.npy"
    classification_file = "/content/drive/My Drive/FM_QualityClassification_Binary_60s_BigData.csv"
    segment_info_file = "/content/drive/My Drive/IMU_Segmented_60s_Group_Info.csv"
    log_file_path = "/content/drive/My Drive/IMU_Segmented_60s_BigDataset_Log.txt"
